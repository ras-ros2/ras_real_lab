...
tmux split-window -v -t main_session:1
tmux send-keys -t main_session:1.0 "ros2 launch ras_app_main main.launch.py" C-m
...
tmux split-window -v -t main_session:2
# tmux send-keys -t main_session:2.0 "ros2 run ras_transport log_sender.py" C-m
# tmux send-keys -t main_session:2.1 "ros2 run ras_bt_framework FakeGripperServer.py" C-m
# tmux send-keys -t main_session:2.1 "ros2 run ras_transport gripper.py" C-m
