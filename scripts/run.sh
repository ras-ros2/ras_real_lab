...
# tmux send-keys -t main_session:3.0 "ros2 run ras_perception aruco_calibration.py" C-m
...
tmux send-keys -t main_session:4.1 "ros2 run ras_perception ros_bridge_client.py" C-m
# tmux send-keys -t main_session:4.2 "pip install roslibpy" C-m
